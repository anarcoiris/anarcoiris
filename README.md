...
Most repositories try to convince you that their author knows all the answers. This profile is almost the opposite.
...
I don't optimize for GitHub stars. I optimize for learning curves.
...
This isn't an IQ test. It's a visualization pulled from hundreds of technical conversations, summarizing how I usually work: deep iterations, frequent assumption-correction, abstraction, long-form reasoning. Take it as a fun metric, not as science.
